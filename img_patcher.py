...
parser.add_argument('JSON_path', nargs='?', default=os.getcwd(), help='Path to the file')
...
img_path = os.path.join(JSON_dir_path, img_name)
...
with open(os.path.join(JSON_dir_path, (data["card_name"] + "_patched.json")), 'w') as file:
